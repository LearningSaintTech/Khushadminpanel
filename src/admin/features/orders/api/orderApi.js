...
const orderEndpoints = {
  ...
  /** Admin cancel item(s) with policy reasons */
  CANCEL_ORDER_ITEMS: (orderId) => `/admin/orders/${orderId}/cancel`,
...
/** Admin cancel order item(s) — policy reasons required */
export const cancelOrderItems = (orderId, body) => {
  return apiConnector("PATCH", orderEndpoints.CANCEL_ORDER_ITEMS(orderId), body);
};
